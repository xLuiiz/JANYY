...
(function($) {
	$.fn.typewriter = function() {
		this.each(function() {
			...
			var normalHtml = fullHtml.replace(delayedMatch ? delayedHtml : '', '');
			...
			var timer = setInterval(function() {
				...
				$ele.html(normalHtml.substring(0, progress) + (progress % 2 ? '_' : ''));
				...
				if (progress >= normalHtml.length) {
					...
					// Após 1 segundo, adiciona e digita o texto delayed
					setTimeout(function() {
						if (delayedHtml) {
